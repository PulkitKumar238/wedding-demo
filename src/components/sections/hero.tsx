  ...
  return (
    ...
    >
      {/*
        ...
        Full bleed on every size, cropped by object-cover — a letterboxed 16:9
        strip on a phone showed the whole frame but read as a small video with
        a lot of page under it.

        The height is a minimum rather than a fixed one, and the top padding
        clears the navbar, which wraps to three rows on a phone. Between them
        the copy can never overflow upward into the nav the way it did when
        this was a fixed 68svh box.
      */}
